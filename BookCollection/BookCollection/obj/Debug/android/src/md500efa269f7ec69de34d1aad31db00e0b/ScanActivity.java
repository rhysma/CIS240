package md500efa269f7ec69de34d1aad31db00e0b;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BookCollection.ScanActivity, BookCollection", ScanActivity.class, __md_methods);
	}
	...
	public ScanActivity ()
	{
		...
		if (getClass () == ScanActivity.class)
			mono.android.TypeManager.Activate ("BookCollection.ScanActivity, BookCollection", "", this, new java.lang.Object[] {  });
	}
